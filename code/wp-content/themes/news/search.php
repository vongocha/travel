    			...
    			<div class="col-md-8 col-sm-8 col-xs-12 fvcm-left">
    				<div class="category-news">
    					<div class="category-news-wrap">
							<h1 class="single-title"><span>Kết quả tìm kiếm: "<?php echo get_search_query(); ?>"</span></h1>
    						<div class="category-content category-module">
    							<div class="row">
    								<div class="col-md-12 col-sm-12 col-xs-12">
    									<form action="<?php bloginfo('url'); ?>" method="GET" role="form" class="form-text-seach">
    										<input type="text" name="s" class="form-control text-class" value="<?php echo get_search_query(); ?>" placeholder="Từ khóa...">
